	    ...
	    <div class="container d-flex align-items-center px-4">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	...
	        	<li class="nav-item active"><a href="contests.jsp" class="nav-link">Contests</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">Home </a></span> <span>Contests</span></p>
          </div>
        </div>
      </div>
    </section>
...
%>
					<div class="col-md-3 course ftco-animate">
						<div class="img" style="background-image: url(images/contests/<%=connection.rs.getString(4)%>);"></div>
						<div class="text pt-4">
							
							<h3><a href="#"><%=connection.rs.getString(2)%></a></h3>
							<p> <%=connection.rs.getString(3)%></p>
							<p><a href="login.jsp"  target="_blank" class="btn btn-primary">Apply now</a></p>
						</div>
					</div>
