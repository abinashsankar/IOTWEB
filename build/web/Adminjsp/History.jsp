    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <section class="panel">
                 <button class="btn btn-primary btn-lg btn-block" onclick="exportTableToExcel('History', 'Trans history')">Download History</button>
<%             
try {
      connect connection=new connect();
    connection.conn();
String QueryString = "SELECT comp_request.request_id,comp_request.email,components.component_name,components.component_model,comp_request.count,comp_request.Date from components  INNER JOIN comp_request ON (components.component_id=comp_request.component_id) WHERE comp_request.Date BETWEEN NOW() - INTERVAL 30 DAY AND NOW()";
