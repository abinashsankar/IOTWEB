                   ...
                   <td>Gallery page</td>
                    <%
                     ...
                     <td>
                                           ...
                                           <% if(connection.rs.getInt(5)==1){
                    %> 
                         <button  type="button" id="<%=connection.rs.getInt(1)%>" class="deletegallery">Delete Totally</button>
                      <button  type="button" id="<%=connection.rs.getInt(1) %>" class="deletemain">Delete From home</button>
...
%>
  ...
  <script src="../js/deletegallery.js"></script>
